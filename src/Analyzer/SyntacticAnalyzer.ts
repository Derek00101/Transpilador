...
// Esta clase revisa los tokens y verifica si el código sigue las reglas del lenguaje.
export class SyntacticAnalyzer {
    ...
    constructor(tokens: Token[]) {
        ...
        // Aquí se definen los tokens que pueden iniciar cada regla gramatical
        this.firsts = [
    ...
    // Analiza una instrucción (declaración, asignación, impresión, if, for)
    private instruction() {
    ...
    // Analiza una instrucción de impresión
    private print() {
